...
namespace EventManagement
{
    public class PlayerEvents
    {
        ...
        // Leaning
        public delegate void BeginLean(Direction leanDirection);
        public BeginLean OnBeginLean;
        public void FireLeanEvent(Direction leanDirection)
        {
            OnBeginLean?.Invoke(leanDirection);
        }
